        ...
        <div class="col-lg-6 text-center text-lg-right">
            <div class="d-inline-flex align-items-center">
                <div class="btn-group">
                    ...
                    @endauth
                    @guest
                    <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Giris Yap</button>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="{{route('login')}}"><button class="dropdown-item" type="button">Giris</button></a>
                        <a href="{{route('register')}}"><button class="dropdown-item" type="button">Uye ol</button></a>
                    </div>
                    @endguest
                </div>
            </div>
    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
            <a href="{{route('index')}}" class="text-decoration-none">
                <span class="h1 text-uppercase text-primary bg-dark px-2">Hepsi</span>
        ...
        <div class="col-lg-4 col-6 text-right">
            ...
            <h5 class="m-0">+090 536 985 4747</h5>
        </div>
    </div>
</div>
<!-- Topbar End -->
